...
public class MyCustomAdapter extends ArrayAdapter<CountryModel> {
    ...
    private List<CountryModel> countryModelList; //Original List For Countries Without search

    private List<CountryModel> countryModelListFiltered; //List Used to Filter Records with Search
